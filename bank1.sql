...
(1, 'Varsha', 'srivarsha4@gmail.com', 146000),
...
(9, 'Teja', 'tejavara@gmail.com', 230000),
(10, 'Chaitanya', 'chaitanya@gmail.com', 100000);
...
(1, 'Varsha', 'Mounika', 4000),
(2, 'Varna', 'Srinija', 1400),
(3, 'Teja', 'Harsha', 10000),
(4, 'Chaitanya', 'Meghna', 1050),
(5, 'Koushik', 'Charan', 3000),
(6, 'Mounika', 'Varna', 1000),
(7, 'Varsha', 'Meghna', 15000),
(8, 'Teja', 'Srinija', 1600);
